...
SELECT TOP (1)
    ...
    CONVERT(bit, COALESCE(HAS_PERMS_BY_NAME(NULL, NULL, N'VIEW SERVER PERFORMANCE STATE'), 0)) AS has_required_permission,
...
WHERE CONVERT(int, SERVERPROPERTY(N'ProductMajorVersion')) = 16;
