...
| **M12 — Reports, installer, upgrades, release hardening** | Reports/exports; WiX and PostgreSQL packaging; Windows Service/gMSA/TLS configuration; install/upgrade/recovery/uninstall; initial-release certification; security/performance/end-to-end gates; release and runbooks | Certification matrix, strict evidence verifier, explicit Local/Release validation profiles, no-hidden-skip gates, and side-effect-free lifecycle/migration assessment foundation implemented locally; reports, packaging, deployment, runtime lifecycle, and external release certification remain incomplete |
