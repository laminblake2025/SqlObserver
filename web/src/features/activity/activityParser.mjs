...
export function parseWaitHistory(value) { const r = object(value); return { evidence: parseEvidence(r.evidence), ...(r.baselineRunId == null ? {} : { baselineRunId: safeGuid(r.baselineRunId) }), wait: parseWait(r.wait) }; }
