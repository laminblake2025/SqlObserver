...
import { getActiveAlerts } from "../src/features/alerts/alertApi.ts";
import { parseActiveAlerts, readJsonBounded } from "../src/features/alerts/alertRuntimeParser.ts";
...
test("production alert parser and bounded streamed reader execute at runtime", async () => {
  ...
  const page = parseActiveAlerts({ targetId: target, snapshotUtc: "2026-08-24T00:00:00Z", nextCursor: null, items: [{ alertId: "22222222-2222-4222-8222-222222222222", ruleId: "33333333-3333-4333-8333-333333333333", state: "firing", firstObservedUtc: "2026-08-24T00:00:00Z", value: null, deliverySuppressed: false }] }, target);
