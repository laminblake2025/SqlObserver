-- Avoid materializing all wide candidates before the bounded top-N sort.
-- Plan each requested time window and metric; retain authorization and cursor semantics.
...
BEGIN
 ...
 (
  ...
  FROM events.query_performance_observation o
