-- Prune the requested time window before joining all historical query identities.
-- Keep row security inside the window scan and all existing snapshot/cursor checks.
...
BEGIN
 ...
 RETURN QUERY
 WITH window_observations AS MATERIALIZED
