-- PostgreSQL regular-expression repetition bounds cannot represent a 512-byte actor.
-- Keep the existing byte/control-character contract and exact replay identity explicitly.
