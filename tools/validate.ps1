...
function Assert-RepositoryShape {
    ...
    if ($m12SqlContractHash -cne '0dcc8e1428d4105a350a076bdba6d2c58fe2d22e932664eef9de3d8fdcd95a8c' -or $m12SqlSchemaHash -cne '5539bba4fe0139b92aadbcd6203526cb3377b689d732e68c70aff60bac843406') { throw 'M12 SQL Server passive contract/schema checksum does not match the approved pin.' }
    ...
    if ($m12ReportsContractHash -cne '4c7fa985f4ed5c11ee2a987ce929cc0c02401f1631e603fd53b8198538affc3a' -or $m12ReportsSchemaHash -cne '80defd27f366b29b46e48bba9d9a7eec2934a41a2aaf5ca38a79ab979e4354ad') { throw 'M12 reports contract/schema checksum does not match the approved pin.' }
    ...
    $m12ReportsAssets = [ordered]@{
        ...
        'database/migrations/checksums.sha256' = 'e63d1a716cd45f1ee4edfcda42b72e5df39c8a6697f57af593ea223849e34e50'
    ...
    if ((Get-FileHash -LiteralPath $m12ReportsProducerPath -Algorithm SHA256).Hash.ToLowerInvariant() -cne '5f87d8681f9a35db3eca18045ee09efc60eac63fb05cd7d8bca3896fa951fc53') { throw 'M12 reports producer source does not match the approved external execution pin.' }
    ...
    if ($m12ObservabilityContractHash -cne 'aec11e6218caf8eef4d7a5109f2dcd0c3f3fefe6a161cd80f69b7a5d8cb1df5a' -or $m12ObservabilitySchemaHash -cne '67bb52221c61df57b463842623f9ccd9f9770d8d7bde78017adc3067ce1b9a58') { throw 'M12 observability contract/schema checksum does not match the approved pin.' }
    ...
    $m12ObservabilityAssets = [ordered]@{
        ...
        'src/SqlObserver.Server/Program.cs' = '15d3790ae44b72ffb332d1e76fc97da5a2cb6d658aff0592cf4f6bf871b922d9'
    ...
    if ((Get-FileHash -LiteralPath $m12ObservabilityProducerPath -Algorithm SHA256).Hash.ToLowerInvariant() -cne '649a27600ab5acc1b4da2e8df4936301f280c0c41435917d35c694f72dc162fd') { throw 'M12 observability producer checksum does not match the externally held release pin.' }
