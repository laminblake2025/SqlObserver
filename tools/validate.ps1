...
function Assert-RepositoryShape {
    ...
    if ((Get-FileHash -LiteralPath $m12ReportsProducerPath -Algorithm SHA256).Hash.ToLowerInvariant() -cne 'd900f96f7ce23a76ef070dd324a83e7e009bea6484a037fd1be4493c963b331b') { throw 'M12 reports producer source does not match the approved external execution pin.' }
    ...
    if ((Get-FileHash -LiteralPath $m12ObservabilityProducerPath -Algorithm SHA256).Hash.ToLowerInvariant() -cne '2a177cd96a6bbaf016b9e42814b3b1bc6621cad87719c6b1345be6e97658308d') { throw 'M12 observability producer checksum does not match the externally held release pin.' }
    ...
    $m12SbomProducerSha256 = 'e06ce59feb1adbff70ccdcae9efcd709612fb2ba776c84dce8d79986ccc1dfba'
