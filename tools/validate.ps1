...
function Assert-RepositoryShape {
    ...
    if ($m12SqlContractHash -cne '970a040d4f82799190d87fa5a32249a167fe5e99afe8fb07d2e1580460d9441a' -or $m12SqlSchemaHash -cne '5539bba4fe0139b92aadbcd6203526cb3377b689d732e68c70aff60bac843406') { throw 'M12 SQL Server passive contract/schema checksum does not match the approved pin.' }
