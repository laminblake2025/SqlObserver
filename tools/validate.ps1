...
function Assert-RepositoryShape {
    ...
    if ($m12SqlContractHash -cne 'a5310947a8ce8cae80df2b21a6e42dfd231f69cdaf8f9377c36b0956d047ad64' -or $m12SqlSchemaHash -cne '5539bba4fe0139b92aadbcd6203526cb3377b689d732e68c70aff60bac843406') { throw 'M12 SQL Server passive contract/schema checksum does not match the approved pin.' }
    ...
    if ($m12ReportsContractHash -cne '11235074ac08184abb71f01cad57e6884e6717291e5a98b697955e548d013a7d' -or $m12ReportsSchemaHash -cne '80defd27f366b29b46e48bba9d9a7eec2934a41a2aaf5ca38a79ab979e4354ad') { throw 'M12 reports contract/schema checksum does not match the approved pin.' }
    ...
    $m12ReportsAssets = [ordered]@{
        ...
        'database/migrations/checksums.sha256' = 'c1ea9b9ed38a33b958862ec59034fe363dcda4fd0728cdcef34cb972ee00e5a7'
    ...
    if ((Get-FileHash -LiteralPath $m12ReportsProducerPath -Algorithm SHA256).Hash.ToLowerInvariant() -cne '4b1f1b7ea6afaa09813ceca018f4d5c91eeb4e4e1b02509894dfbaed259df848') { throw 'M12 reports producer source does not match the approved external execution pin.' }
    ...
    if ($m12ObservabilityContractHash -cne '9d6c09f18762b19736cf2c59bc243ed016e99d4022459cc5650d6e85ffa9df3b' -or $m12ObservabilitySchemaHash -cne '67bb52221c61df57b463842623f9ccd9f9770d8d7bde78017adc3067ce1b9a58') { throw 'M12 observability contract/schema checksum does not match the approved pin.' }
    ...
    $m12ObservabilityAssets = [ordered]@{
        ...
        'src/SqlObserver.Collector/CollectorServiceRegistration.cs' = '2fb0464ebef72eae2c4269b6bec754d468f790d21b66838d8a45fcbcb0ea4bea'
    ...
    if ((Get-FileHash -LiteralPath $m12ObservabilityProducerPath -Algorithm SHA256).Hash.ToLowerInvariant() -cne '215025540fe0939d9ba5e4122a6ffd8ddac5abe498146da8a8638ff03c3c8da8') { throw 'M12 observability producer checksum does not match the externally held release pin.' }
