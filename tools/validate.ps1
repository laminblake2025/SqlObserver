...
function Assert-RepositoryShape {
    ...
    if ($m12ReportsContractHash -cne 'f357d66f9564278a347f6512da58130e20a7e3b58851ba6050e5a8bb2ea25069' -or $m12ReportsSchemaHash -cne '80defd27f366b29b46e48bba9d9a7eec2934a41a2aaf5ca38a79ab979e4354ad') { throw 'M12 reports contract/schema checksum does not match the approved pin.' }
    ...
    $m12ReportsAssets = [ordered]@{
        ...
        'database/migrations/checksums.sha256' = 'cf728b19e764b1f3d493c0d676a1c80fa3cf3da5079c65952da17095f2ca1834'
    ...
    if ((Get-FileHash -LiteralPath $m12ReportsProducerPath -Algorithm SHA256).Hash.ToLowerInvariant() -cne '02db48647b8b4e6601a7d3db1a8db7ba5bcca5f3de7b7d25b47966a741b57d0f') { throw 'M12 reports producer source does not match the approved external execution pin.' }
